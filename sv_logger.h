...
void sv_logger_record_op(sv_mask mask, int latency); // Records a masked vector operation
void sv_logger_record_unmasked_op(int latency); // Records a full-width vector operation
void sv_logger_record_scalar_op(int latency); // Records a scalar (SimFloat) operation (1 lane)
